...
JLoader::registerPrefix('Adres', JPATH_SITE . '/components/com_adres/');
 ...
 * @since  3.3
 */
class AdresRouter extends JComponentRouterBase
{
	/**
	...
	public function build(&$query)
	{
		...
		if (isset($query['id']))
		{
			if ($view !== null)
			{
				$model      = AdresHelpersAdres::getModel($view);
				if($model !== null){
	...
	public function parse(&$segments)
	{
		...
		$model = AdresHelpersAdres::getModel($vars['view']);
