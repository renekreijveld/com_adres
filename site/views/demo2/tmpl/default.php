...
<div id="mapdiv" style="width: 100%; height: 600px; margin-bottom: 1em;"></div>
<script type="text/javascript">
    // Globale map variable
    var map;
    var joomladagenLocatie = new google.maps.LatLng(52.085995,5.2819908);
    // Toon kaart als DOM geladen is
    function loadMap() {
        // Map opties
        var mapOptions = {
            zoom: 7,
            center: new google.maps.LatLng(52.085995,5.2819908),
        };
        var mapId = document.getElementById('mapdiv');
        map = new google.maps.Map(mapId,mapOptions);
        var marker = new google.maps.Marker({
            position: joomladagenLocatie,
            map: map,
            title: 'Joomladagen 2016'
        });
    }
    google.maps.event.addDomListener(window, 'load', loadMap());
</script>
<form action="<?php echo JRoute::_('index.php?option=com_adres&view=demo2'); ?>" method="post" name="adminForm" id="adminForm">
