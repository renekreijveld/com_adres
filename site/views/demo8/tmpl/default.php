...
$document->addScript('/components/com_adres/assets/js/markerclusterer_compiled.js');
...
<form action="<?php echo JRoute::_('index.php?option=com_adres&view=demo8'); ?>" method="post" name="adminForm" id="adminForm">
